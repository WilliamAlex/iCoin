...
// 菜单显示区域占屏幕宽度的百分比
static CGFloat MenuWidthScale = 0.6f;

// 遮盖层最高透明度
static CGFloat MaxCoverAlpha = 0.3;


@interface ABSlideMenuViewController ()<UIGestureRecognizerDelegate>
{
...
@implementation ABSlideMenuViewController
